...
class Hamming_exemplo(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Hamming_exemplo")
        ...
        self.ITpp_BSC_Byte_0 = ITpp.BSC_Byte(1, 0.786)
        ...
        # Connections
        ##################################################
        self.connect((self.ITpp_BSC_Byte_0, 0), (self.ITpp_Hamming_Soft_Decoder_0, 0))
        ...
        self.connect((self.ITpp_Hamming_Soft_Decoder_0, 0), (self.blocks_uchar_to_float_0_0, 0))
...
def main(top_block_cls=Hamming_exemplo, options=None):

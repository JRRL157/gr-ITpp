...
class BER_Simulation_3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "BER_Simulation_3")
        ...
        self.connect((self.testing_NoiseConverter_0, 1), (self.ITpp_BER_Analyzer_cpp_0, 0))
...
def main(top_block_cls=BER_Simulation_3, options=None):

...
class BER_Simulation_4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "BER_Simulation_4")
...
def main(top_block_cls=BER_Simulation_4, options=None):
